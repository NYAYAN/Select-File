(function () {
    ...
    window.onload = function () {
      ...
      function FillList(key, files) {
        ...
        for (file of files) {
          ...
          if (file != null) {
            if (filteredData.size != undefined) {
              if (filteredData.size < file.size) {
                file.isValid = false;
              }
            }
        ...
        if (filteredData.totalSize != undefined) {
          if (filteredData.totalSize < totalFilesSize) {
            NY.FilePlugin.files[filteredData.index].totalSizeIsValid = false;
          } else {
            NY.FilePlugin.files[filteredData.index].totalSizeIsValid = true;
          }
        }
